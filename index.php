...
<body>
    ...
    if (isset($headers['x-up-calling-line-id'])) {
        $phone_number = $headers['x-up-calling-line-id'];
        echo "<p>Your phone number is:</p><h1>$phone_number</h1><p>Did you know that this number is sent to <strong>every</strong> website you visit (when not using Wi-Fi)?</p>";
    } else {
